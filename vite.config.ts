...
export default defineConfig(({ mode }) => {
  ...
  // Overridable for hosting under a subpath, e.g. GitHub Pages project sites
  // (https://<user>.github.io/<repo>/) via VITE_BASE_PATH=/<repo>/ in CI.
  const base = process.env.VITE_BASE_PATH ?? (singleFileMode ? './' : '/')
